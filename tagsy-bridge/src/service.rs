...
//! alive. So the runtime cannot be owned by the Dart-side [`TagsyApp`]; it is
...
/// ([`Backend::ipc_default`], `/run/tagsy/tagsy.sock`) and stores it in the
